    ...
    function ($, layout, util, cluster, bib) {
        ...
        function initResult() {
            ...
            $('<div>', {
                ...
                text: 'curated references for sentiment-aware crypto and financial trading'
            }).appendTo(resultHeaderDiv);
            $('<div>', {
                id: 'result_body',
        ...
        function applyLayout() {
            function getWestSize() {
                return Math.min(560, Math.max(420, $(window).width() * 0.38));
            }
            ...
            layout.sizePane('west', getWestSize());
            ...
            window.adaptHeaderSize = function () {
                var titleDiv = $('#title');
                var titleHeight = Math.max(titleDiv.outerHeight(true), titleDiv.get(0).scrollHeight);
                var selectorsHeight = $('#selectors_container').outerHeight(true);
                var height = titleHeight + selectorsHeight + 28;
                layout.sizePane('north', height);
            }

            window.adaptLayoutSize = function () {
                layout.sizePane('west', getWestSize());
